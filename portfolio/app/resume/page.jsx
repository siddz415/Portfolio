...
{
      fieldName: "Location",
      fieldValue: "San Francisco, CA, USA",
    },
  ],
};
...
const experience = {
  ...
  items: [
    ...
    {
      company: "Zoox",
      position: "Level 5 Linux Technician",
      duration: "2023",
    },
    {
    ...
    },
    {
      ...
      position: "Product Engineering Group",
      duration: "2018 - 2022",
    },
  ],
};
...
const education = {
  ...
  title: "My Courses",
  description: "I have a wide range of experience in the field of web development. I have a passion for learning and exploring new technologies. I am always looking to improve my skills and knowledge. Here are some of the courses I have completed:",
  items: [
    {
...
const skills = {
  title: "My Skills",
  description:
    "My skills include front-end development with HTML, CSS, JavaScript, and Python, alongside frameworks like React. On the back-end, I work with Node.js, Next.js and databases like MongoDB. I’m also proficient in UI/UX design, responsive web design, and SEO best practices to create well-rounded digital experiences.",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "html 5",
